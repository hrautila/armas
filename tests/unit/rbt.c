...
void make_butterfly(armas_x_dense_t *A, armas_x_dense_t *U)
{
...
void create_rbt_matrix(armas_x_dense_t *U2, armas_x_dense_t *U1, armas_x_dense_t *S, int N, int Nd, int P)
{
...
int test_rbt_lufactor(int N, int P, int verbose)
{
    ...
    armas_x_set(&A0, 0, 1, 1.0);
    armas_x_set(&A0, 1, 0, 1.0);
    armas_x_set(&A0, 1, 1, 0.5+_EPS);
    armas_x_mcopy(&A1, &A0);
