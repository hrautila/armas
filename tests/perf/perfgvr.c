...
static inline
void gvright(armas_dense_t *A, double c, double s, int c1, int c2, int row, int nrow)
{
...
int test_gvright(armas_dense_t *A, double c, double s)
{
  int k;
...
#ifdef __AVX__
static inline
void gvright_avx(armas_dense_t *A, double c, double s, int c1, int c2, int row, int nrow)
{
...
int test_gvright_avx(armas_dense_t *A, double c, double s)
{
#ifdef __AVX__
  int k;
  for (k = 0; k < A->cols-1; k++) {
...
static inline
void gvleft(armas_dense_t *A, double c, double s, int r1, int r2, int col, int ncol)
{
    double t0, t1, *y0, *y1;
    int k, n;
...
int test_gvleft(armas_dense_t *A, double c, double s)
{
  int k;
...
#ifdef __AVX__
void gvleft_avx(armas_dense_t *A, double c, double s, int r1, int r2, int col, int ncol)
{
...
int test_gvleft_avx(armas_dense_t *A, double c, double s)
{
#ifdef __AVX__
  int k;
  for (k = 0; k < A->rows-1; k++) {
