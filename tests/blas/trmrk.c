...
int main(int argc, char **argv)
{
    ...
    // ----------------------------------------------------------------------------
    // 2. C = upper(C) + A.T*B
    armas_x_update_trm(0.0, &C, alpha, &At, &B, ARMAS_UPPER | ARMAS_TRANSA,
                       &conf);
    n0 = rel_error(&n1, &C, &C0, ARMAS_NORM_ONE, ARMAS_NONE, &conf);
    ok = n0 == 0 || isOK(n0, N) ? 1 : 0;
    ...
    // ----------------------------------------------------------------------------
    // 3. C = upper(C) + A*B.T
    armas_x_update_trm(0.0, &C, alpha, &A, &Bt, ARMAS_UPPER | ARMAS_TRANSB,
                       &conf);
    n0 = rel_error(&n1, &C, &C0, ARMAS_NORM_ONE, ARMAS_NONE, &conf);
    ok = n0 == 0 || isOK(n0, N) ? 1 : 0;
    ...
    // ----------------------------------------------------------------------------
    // 4. C = upper(C) + A.T*B.T
    armas_x_update_trm(0.0, &C, alpha, &At, &Bt,
                       ARMAS_UPPER | ARMAS_TRANSA | ARMAS_TRANSB, &conf);
    n0 = rel_error(&n1, &C, &C0, ARMAS_NORM_ONE, ARMAS_NONE, &conf);
    ok = n0 == 0 || isOK(n0, N) ? 1 : 0;
    ...
    // ----------------------------------------------------------------------------
    // 2. C = lower(C) + A.T*B
    armas_x_update_trm(0.0, &C, alpha, &At, &B, ARMAS_LOWER | ARMAS_TRANSA,
                       &conf);
    n0 = rel_error(&n1, &C, &C0, ARMAS_NORM_ONE, ARMAS_NONE, &conf);
    ok = n0 == 0 || isOK(n0, N) ? 1 : 0;
    ...
    // ----------------------------------------------------------------------------
    // 3. C = lower(C) + A*B.T
    armas_x_update_trm(0.0, &C, alpha, &A, &Bt, ARMAS_LOWER | ARMAS_TRANSB,
                       &conf);
    n0 = rel_error(&n1, &C, &C0, ARMAS_NORM_ONE, ARMAS_NONE, &conf);
    ok = n0 == 0 || isOK(n0, N) ? 1 : 0;
    ...
    // 4. C = lower(C) + A.T*B.T
    armas_x_update_trm(0.0, &C, alpha, &At, &Bt,
                       ARMAS_LOWER | ARMAS_TRANSA | ARMAS_TRANSB, &conf);
    n0 = rel_error(&n1, &C, &C0, ARMAS_NORM_ONE, ARMAS_NONE, &conf);
    ok = n0 == 0 || isOK(n0, N) ? 1 : 0;
