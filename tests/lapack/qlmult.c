...
int test_mult_identity(int M, int N, int lb, int verbose)
{
    ...
    // factorize
    armas_qlfactor(&A0, &tau0, &conf);

    // compute Q.T*(Q*I)
    armas_qlmult(&C, &A0, &tau0, ARMAS_LEFT, &conf);
    armas_qlmult(&C, &A0, &tau0, ARMAS_LEFT | ARMAS_TRANS, &conf);
...
int test_mult_left(int M, int N, int lb, int verbose)
{
    ...
    // compute C0 = Q.T*Q*C0
    armas_qlmult(&C0, &A0, &tau0, ARMAS_LEFT, &conf);
    armas_qlmult(&C0, &A0, &tau0, ARMAS_LEFT | ARMAS_TRANS, &conf);
...
int test_mult_right(int M, int N, int lb, int verbose)
{
    ...
    // compute C0 = C0*Q.T*Q
    armas_qlmult(&C0, &A0, &tau0, ARMAS_RIGHT | ARMAS_TRANS, &conf);
    armas_qlmult(&C0, &A0, &tau0, ARMAS_RIGHT, &conf);
