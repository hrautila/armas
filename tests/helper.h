...
// NOTE: this file is included __ONLY__ after DTYPE and armas_x_dense_t typedefs.
...
extern int check(armas_x_dense_t *A, armas_x_dense_t *B, int chkdir, const char *msg);
...
extern DTYPE ep_dot_n(armas_x_dense_t *X, armas_x_dense_t *Y, DTYPE start, int N, int prec);
extern DTYPE ep_dot(armas_x_dense_t *X, armas_x_dense_t *Y, DTYPE start, int prec);
...
extern void ep_axpy(armas_x_dense_t *X, armas_x_dense_t *Y, DTYPE alpha, DTYPE beta, int prec);
extern void ep_gemv(armas_x_dense_t *Y, armas_x_dense_t *A, armas_x_dense_t *X,
                    DTYPE alpha, DTYPE beta, int prec, int flags);
extern void ep_gemm(armas_x_dense_t *C, armas_x_dense_t *A, armas_x_dense_t *B,
                    DTYPE alpha, DTYPE beta, int prec, int flags);

extern void ep_gendot(double *dot, double *tcond,
                      armas_x_dense_t *X, armas_x_dense_t *Y, double cond);
extern void ep_gensum(double *dot, double *tcond, armas_x_dense_t *X, double cond);
extern void ep_genmat(double *dot, double *tcond, armas_x_dense_t *A, armas_x_dense_t *B, double cond);
extern void ep_gentrm(double *dot, double *tcond, armas_x_dense_t *A, armas_x_dense_t *B, double cond, int flags);
