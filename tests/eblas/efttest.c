...
int test_twosum_extf32(int verbose)
{
    ...
    if (verbose)
        printf
            ("twosum_extf32: |ah,al| > |bh,bl|, (1000.0, -eps) + (1.0+eps, 0.0)\n");
...
int test_twoprod_extf32(int verbose)
{
    ...
    if (verbose)
        printf
            ("twoprod_extf32: (2.0 - 2.0*eps, eps*eps) * (2.0 + 2.0*eps, eps*eps)\n");
...
int test_twoprod_extf64(int verbose)
{
    ...
    if (verbose)
        printf
            ("twoprod_extf64: (1.0 - eps, eps*eps/2.0) * (1.0 + eps, eps*eps/2.0)\n");
