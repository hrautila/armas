...
#ifndef ARMAS_LAPACK_SYM_H
#define ARMAS_LAPACK_SYM_H
...
/*
 * Apply diagonal pivot (row and column swapped) to symmetric LOWER
 * triangular matrix blocks. This is a partial swap; rows left srcix are
 * not touched. (Pivot root is at the  top-left corner of the block.)
 *
 *    -----------------------
 *    | d 
...
/*
 * Apply diagonal pivot (row and column swapped) to symmetric LOWER triangular
 * matrix blocks.This is a partial swap; Pivot root (P1) is assumed to be at
