 ...
 */
__ARMAS_INLINE
void __partition_2x1(armas_x_dense_t *AT, armas_x_dense_t *AB,
 ...
 */
__ARMAS_INLINE
void __repartition_2x1to3x1(armas_x_dense_t *AT, armas_x_dense_t *A0,
 ...
 */
__ARMAS_INLINE
void __continue_3x1to2x1(armas_x_dense_t *AT, armas_x_dense_t *AB,
 ...
 */
__ARMAS_INLINE
void __partition_1x2(armas_x_dense_t *AL, armas_x_dense_t *AR,
                     const armas_x_dense_t *A, int nb, int side)
{
  if (nb > A->cols) {
    nb = A->cols;
 ...
 */
__ARMAS_INLINE
void __repartition_1x2to1x3(armas_x_dense_t *AL, armas_x_dense_t *A0,
                            armas_x_dense_t *A1, armas_x_dense_t *A2,
                            const armas_x_dense_t *A, int nb, int direction)
{
  switch (direction) {
 ...
 */
__ARMAS_INLINE
void __continue_1x3to1x2(armas_x_dense_t *AL, armas_x_dense_t *AR,
                         armas_x_dense_t *A0, armas_x_dense_t *A1,
                         const armas_x_dense_t *A, int direction) 
{
  int nl;
 ...
 */
__ARMAS_INLINE
void __partition_2x2(armas_x_dense_t *ATL, armas_x_dense_t *ATR,
 ...
 */
__ARMAS_INLINE
void __repartition_2x2to3x3(armas_x_dense_t *ATL,
 ...
 */
__ARMAS_INLINE
void __continue_3x3to2x2(armas_x_dense_t *ATL, armas_x_dense_t *ATR,
                         armas_x_dense_t *ABL, armas_x_dense_t *ABR,
 ...
 */
__ARMAS_INLINE
void __merge2x1(armas_x_dense_t *ABLK, armas_x_dense_t *AT, armas_x_dense_t *AB)
{
 ...
 */
__ARMAS_INLINE
void __merge1x2(armas_x_dense_t *ABLK, armas_x_dense_t *AL, armas_x_dense_t *AR)
{
