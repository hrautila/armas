...
static inline
void __mmul_lower(armas_x_dense_t *A, const armas_x_dense_t *B, int nR, int nC)
{
...
static inline
void __mmul_upper(armas_x_dense_t *A, const armas_x_dense_t *B, int nR, int nC)
{
  register int i, j, k, lda, ldb;
  DTYPE *a, *b;
...
static inline
void __mmul_upper_abs(armas_x_dense_t *A, const armas_x_dense_t *B, int nR, int nC)
{
  register int i, j, k, lda, ldb;
  DTYPE *a, *b;
...
static inline
void __mmul(armas_x_dense_t *A, const armas_x_dense_t *B, int nR, int nC, int flags)
{
 ...
 * \ingroup matrix
 */
int armas_x_mul_elems(armas_x_dense_t *A, const armas_x_dense_t *B, int flags)
{

  if (armas_x_size(A) == 0 || armas_x_size(B) == 0)
    return 0;
  if (armas_x_size(B) == 1)
    return armas_x_mscale(A, armas_x_get_unsafe(B, 0, 0), flags);
