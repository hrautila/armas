...
#ifndef ARMAS_MVEC_NOSIMD_H
#define ARMAS_MVEC_NOSIMD_H 1

static inline
void vscale(DTYPE * X, int incx, DTYPE alpha, int N)
{
    register int i, k;
...
static inline
void vmult1axpy(DTYPE * y, int incy,
...
static inline
void vmult1axpy_abs(DTYPE * y, int incy,
                    const DTYPE * a0, const DTYPE * x, int incx,
                    DTYPE alpha, int nR)
{
    register int k;
...
static inline
void vmult2axpy(DTYPE * y, int incy,
                const DTYPE * a0, const DTYPE * a1,
                const DTYPE * x, int incx, DTYPE alpha, int nR)
{
    register int k;
...
static inline
void vmult2axpy_abs(DTYPE * y, int incy,
                    const DTYPE * a0, const DTYPE * a1,
                    const DTYPE * x, int incx, DTYPE alpha,
                    int nR)
{
    register int k;
    register DTYPE cf0, cf1, t0, t1, t2, t3, t4, t5, t6, t7;
...
static inline
    void vmult4axpy(DTYPE * y, int incy,
                    const DTYPE * a0, const DTYPE * a1, const DTYPE * a2,
                    const DTYPE * a3, const DTYPE * x, int incx, DTYPE alpha,
                    int nR)
{
    register int k;
...
static inline
    void vmult4axpy_abs(DTYPE * y, int incy,
                        const DTYPE * a0, const DTYPE * a1, const DTYPE * a2,
                        const DTYPE * a3, const DTYPE * x, int incx,
                        DTYPE alpha, int nR)
{
    register int k;
    register DTYPE cf0, cf1, cf2, cf3, t0, t1, t2, t3, t4, t5, t6, t7;
...
static inline
    void vmult1dot(DTYPE * y, int incy,
                   const DTYPE * a0, const DTYPE * x, int incx,
                   DTYPE alpha, int nR)
{
    register int k;
...
static inline
    void vmult1dot_abs(DTYPE * y, int incy,
                       const DTYPE * a0, const DTYPE * x, int incx,
                       DTYPE alpha, int nR)
{
    register int k;
...
static inline
    void vmult2dot(DTYPE * y, int incy,
                   const DTYPE * a0, const DTYPE * a1, const DTYPE * x,
                   int incx, DTYPE alpha, int nR)
{
    register int k;
...
static inline
    void vmult2dot_abs(DTYPE * y, int incy,
                       const DTYPE * a0, const DTYPE * a1,
                       const DTYPE * x, int incx, DTYPE alpha, int nR)
{
    register int k;
...
static inline
    void vmult4dot(DTYPE * y, int incy,
                   const DTYPE * a0, const DTYPE * a1, const DTYPE * a2,
                   const DTYPE * a3, const DTYPE * x, int incx,
                   DTYPE alpha, int nR)
{
...
static inline
    void vmult4dot_abs(DTYPE * y, int incy,
                       const DTYPE * a0, const DTYPE * a1, const DTYPE * a2,
                       const DTYPE * a3, const DTYPE * x, int incx,
                       DTYPE alpha, int nR)
{
