...
#define armas_set_all       armas_c_set_all
...
//
#define armas_uniform       armas_c_uniform
#define armas_uniform_at    armas_c_uniform_at
#define armas_normal        armas_c_normal
#define armas_normal_at     armas_c_normal_at
