...
extern int armas_x_mcopy(armas_x_dense_t *d, const armas_x_dense_t *s, int flags, armas_conf_t *cf);
...
extern int armas_x_mult_sym(
    DTYPE beta, armas_x_dense_t *C, DTYPE alpha, const armas_x_dense_t *A, const armas_x_dense_t *B,
    int flags, armas_conf_t *cf);

extern int armas_x_mult_trm(
    armas_x_dense_t *B, DTYPE alpha, const armas_x_dense_t *A, int flags, armas_conf_t *cf);

extern int armas_x_solve_trm(
    armas_x_dense_t *B, DTYPE alpha, const armas_x_dense_t *A, int flags, armas_conf_t *cf);

extern int armas_x_update_trm(
    DTYPE beta, armas_x_dense_t *C, DTYPE alpha, const armas_x_dense_t *A, const armas_x_dense_t *B,
    int flags, armas_conf_t *cf);

extern int armas_x_update_sym(
    DTYPE beta, armas_x_dense_t *C, DTYPE alpha, const armas_x_dense_t *A, int flags, armas_conf_t *cf);

extern int armas_x_update2_sym(
    DTYPE beta, armas_x_dense_t *C, DTYPE alpha, const armas_x_dense_t *A, const armas_x_dense_t *B,
    int flags, armas_conf_t *cf);

// Extendded precision BLAS
extern int armas_x_ext_adot(
    DTYPE *result, DTYPE alpha, const armas_x_dense_t *x, const armas_x_dense_t *y, armas_conf_t *cf);

extern int armas_x_ext_asum(
    DTYPE *result, DTYPE alpha, const armas_x_dense_t *x, int flags, armas_conf_t *cf);

extern int armas_x_ext_axpby(
    DTYPE beta, armas_x_dense_t *Y, DTYPE alpha, const armas_x_dense_t *X, armas_conf_t *cf);

extern int armas_x_ext_mvmult(
    DTYPE beta, armas_x_dense_t *y, DTYPE alpha, const armas_x_dense_t *A, const armas_x_dense_t *x,
    int flags, armas_conf_t *cf);

extern int armas_x_ext_mvmult_trm(
    armas_x_dense_t *X, DTYPE alpha, const armas_x_dense_t *A, int flags, armas_conf_t *cf);

extern int armas_x_ext_mvsolve_trm_w(
    armas_x_dense_t *X, DTYPE alpha, const armas_x_dense_t *A, int flags, armas_wbuf_t *w, armas_conf_t *cf);

extern int armas_x_ext_mvsolve_trm(
    armas_x_dense_t *X, DTYPE alpha, const armas_x_dense_t *A, int flags, armas_conf_t *cf);

extern int armas_x_ext_mvmult_sym(
    DTYPE beta, armas_x_dense_t *y, DTYPE alpha, const armas_x_dense_t *A, const armas_x_dense_t *x,
    int flags, armas_conf_t *cf);
...
extern int armas_x_ext_mult_trm(
    armas_x_dense_t *B, DTYPE alpha, const armas_x_dense_t *A, int flags, armas_conf_t *cf);

extern int armas_x_ext_mult_sym(
    DTYPE beta, armas_x_dense_t *C, DTYPE alpha, const armas_x_dense_t *A, const armas_x_dense_t *B,
    int flags, armas_conf_t *cf);

extern int armas_x_ext_solve_trm_w(
    armas_x_dense_t *X, DTYPE alpha, const armas_x_dense_t *A, int flags, armas_wbuf_t *w, armas_conf_t *cf);

extern int armas_x_ext_solve_trm(
    armas_x_dense_t *X, DTYPE alpha, const armas_x_dense_t *A, int flags, armas_conf_t *cf);

extern int armas_x_ext_update_trm(
    DTYPE beta, armas_x_dense_t *C, DTYPE alpha, const armas_x_dense_t *A, const armas_x_dense_t *B,
    int flags, armas_conf_t *cf);
// Lapack

// Bidiagonal reduction
extern int armas_x_bdreduce(
    armas_x_dense_t *A, armas_x_dense_t *tauq, armas_x_dense_t *taup, armas_conf_t *cf);

extern int armas_x_bdreduce_w(
    armas_x_dense_t *A, armas_x_dense_t *tauq, armas_x_dense_t *taup, armas_wbuf_t *w, armas_conf_t *cf);

extern int armas_x_bdbuild(
    armas_x_dense_t *A, const armas_x_dense_t *tau, int K, int flags, armas_conf_t *cf);

extern int armas_x_bdbuild_w(
    armas_x_dense_t *A, const armas_x_dense_t *tau, int K, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_bdmult(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_conf_t *cf);

extern int armas_x_bdmult_w(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_wbuf_t *w, armas_conf_t *cf);

// Cholesky
extern int armas_x_cholesky(armas_x_dense_t *A, int flags, armas_conf_t *cf);

extern int armas_x_cholfactor(armas_x_dense_t *A, armas_pivot_t *P, int flags, armas_conf_t *cf);

extern int armas_x_cholfactor_w(armas_x_dense_t *A, armas_pivot_t *P, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_cholsolve(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_pivot_t *P, int flags, armas_conf_t *cf);

extern int armas_x_cholupdate(armas_x_dense_t *A, armas_x_dense_t *X, int flags, armas_conf_t *cf);

// Hessenberg reduction
extern int armas_x_hessreduce(armas_x_dense_t *A, armas_x_dense_t *tau, armas_conf_t *cf);

extern int armas_x_hessmult(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_conf_t *cf);

extern int armas_x_hessreduce_w(
    armas_x_dense_t *A, armas_x_dense_t *tau, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_hessmult_w(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

// LU
extern int armas_x_lufactor(armas_x_dense_t *A, armas_pivot_t *P, armas_conf_t *cf);
...
extern int armas_x_bksolve_w(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_pivot_t *P, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

// LDL.T symmetric
extern int armas_x_ldlfactor(armas_x_dense_t *A, armas_pivot_t *P, int flags, armas_conf_t *cf);

extern int armas_x_ldlfactor_w(armas_x_dense_t *A, armas_pivot_t *P, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_ldlsolve(armas_x_dense_t *B, const armas_x_dense_t *A, const armas_pivot_t *P, int flags, armas_conf_t *cf);

// LQ functions
extern int armas_x_lqbuild(armas_x_dense_t *A, const armas_x_dense_t *tau, int K, armas_conf_t *cf);

extern int armas_x_lqfactor(armas_x_dense_t *A, armas_x_dense_t *tau, armas_conf_t *cf);

extern int armas_x_lqmult(
    armas_x_dense_t *C, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_conf_t *cf);

extern int armas_x_lqreflector(
    armas_x_dense_t *T, armas_x_dense_t *V, armas_x_dense_t *tau, armas_conf_t *cf);

extern int armas_x_lqsolve(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_conf_t *cf);

extern int armas_x_lqbuild_w(
    armas_x_dense_t *A, const armas_x_dense_t *tau, int K, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_lqfactor_w(
    armas_x_dense_t *A, armas_x_dense_t *tau, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_lqmult_w(
    armas_x_dense_t *C, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_lqsolve_w(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

// QL functions
extern int armas_x_qlbuild(armas_x_dense_t *A, const armas_x_dense_t *tau, int K, armas_conf_t *cf);

extern int armas_x_qlfactor(armas_x_dense_t *A, armas_x_dense_t *tau, armas_conf_t *cf);

extern int armas_x_qlmult(
    armas_x_dense_t *C, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_conf_t *cf);

extern int armas_x_qlreflector(
    armas_x_dense_t *T, armas_x_dense_t *V, armas_x_dense_t *tau, armas_conf_t *cf);

extern int armas_x_qlbuild_w(
    armas_x_dense_t *A, const armas_x_dense_t *tau, int K, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_qlfactor_w(
    armas_x_dense_t *A, armas_x_dense_t *tau, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_qlmult_w(
    armas_x_dense_t *C, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_qlsolve_w(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

// QR functions
extern int armas_x_qrbuild(armas_x_dense_t *A, const armas_x_dense_t *tau, int K, armas_conf_t *cf);

extern int armas_x_qrfactor(armas_x_dense_t *A, armas_x_dense_t *tau, armas_conf_t *cf);

extern int armas_x_qrmult(
    armas_x_dense_t *C, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_conf_t *cf);

extern int armas_x_qrreflector(
    armas_x_dense_t *T, armas_x_dense_t *V, armas_x_dense_t *tau, armas_conf_t *cf);

extern int armas_x_qrsolve(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_conf_t *cf);

extern int armas_x_qrbuild_w(
    armas_x_dense_t *A, const armas_x_dense_t *tau, int K, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_qrfactor_w(
    armas_x_dense_t *A, armas_x_dense_t *tau, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_qrmult_w(
    armas_x_dense_t *C, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);
...
// RQ functions
extern int armas_x_rqbuild(armas_x_dense_t *A, const armas_x_dense_t *tau, int K, armas_conf_t *cf);

extern int armas_x_rqfactor(armas_x_dense_t *A, armas_x_dense_t *tau, armas_conf_t *cf);

extern int armas_x_rqmult(
    armas_x_dense_t *C, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_conf_t *cf);

extern int armas_x_rqreflector(
    armas_x_dense_t *T, armas_x_dense_t *V, armas_x_dense_t *tau, armas_conf_t *cf);

extern int armas_x_rqsolve(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_conf_t *cf);

extern int armas_x_rqbuild_w(
    armas_x_dense_t *A, const armas_x_dense_t *tau, int K, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_rqfactor_w(
    armas_x_dense_t *A, armas_x_dense_t *tau, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_rqmult_w(
    armas_x_dense_t *C, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_rqsolve_w(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_wbuf_t *W, armas_conf_t *cf);

// Tridiagonal reduction
extern int armas_x_trdreduce(armas_x_dense_t *A, armas_x_dense_t *tau, int flags, armas_conf_t *cf);

extern int armas_x_trdbuild(
    armas_x_dense_t *A, const armas_x_dense_t *tau, int K, int flags, armas_conf_t *cf);

extern int armas_x_trdmult(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_conf_t *cf);

extern int armas_x_trdreduce_w(
    armas_x_dense_t *A, armas_x_dense_t *tau, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_trdbuild_w(
    armas_x_dense_t *A, const armas_x_dense_t *tau, int K, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_trdmult_w(
    armas_x_dense_t *B, const armas_x_dense_t *A, const armas_x_dense_t *tau, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_trdeigen(
    armas_x_dense_t *D, armas_x_dense_t *E, armas_x_dense_t *V, int flags, armas_conf_t *cf);

extern int armas_x_trdeigen_w(
...
extern int armas_x_trdsec_solve(
    armas_x_dense_t *y, armas_x_dense_t *d, armas_x_dense_t *z, armas_x_dense_t *delta, DTYPE rho, armas_conf_t *cf);

extern int armas_x_trdsec_solve_vec(
    armas_x_dense_t *y, armas_x_dense_t *v, armas_x_dense_t *Qd, armas_x_dense_t *d, armas_x_dense_t *z, DTYPE rho, armas_conf_t *cf);

extern int armas_x_trdsec_eigen(
    armas_x_dense_t *Q, armas_x_dense_t *v, armas_x_dense_t *Qd, armas_conf_t *cf);
...
extern int armas_x_gvupdate(
    armas_x_dense_t *A, int start, armas_x_dense_t *C, armas_x_dense_t *S, int nrot, int flags);

extern int armas_x_gvrot_vec(armas_x_dense_t *X, armas_x_dense_t *Y, DTYPE c, DTYPE s);

// Bidiagonal SVD
extern int armas_x_bdsvd(
    armas_x_dense_t *D, armas_x_dense_t *E, armas_x_dense_t *U, armas_x_dense_t *V, int flags, armas_conf_t *cf);

extern int armas_x_bdsvd_w(
    armas_x_dense_t *D, armas_x_dense_t *E, armas_x_dense_t *U, armas_x_dense_t *V, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_svd(
    armas_x_dense_t *S, armas_x_dense_t *U, armas_x_dense_t *V, armas_x_dense_t *A, int flags, armas_conf_t *cf);

extern int armas_x_svd_w(
    armas_x_dense_t *S, armas_x_dense_t *U, armas_x_dense_t *V, armas_x_dense_t *A, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

// Eigen
extern int armas_x_eigen_sym(
    armas_x_dense_t *D, armas_x_dense_t *A, int flags, armas_conf_t *cf);

extern int armas_x_eigen_sym_w(
    armas_x_dense_t *D, armas_x_dense_t *A, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_eigen_sym_selected(
    armas_x_dense_t *D, armas_x_dense_t *A, const armas_x_eigen_parameter_t *params, int flags, armas_conf_t *cf);

extern int armas_x_eigen_sym_selected_w(
    armas_x_dense_t *D, armas_x_dense_t *A, const armas_x_eigen_parameter_t *params, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

// DQDS
extern int armas_x_dqds(armas_x_dense_t *D, armas_x_dense_t *E, armas_conf_t *cf);

extern int armas_x_dqds_w(armas_x_dense_t *D, armas_x_dense_t *E, armas_wbuf_t *wrk, armas_conf_t *cf);

// Householder functions
extern int armas_x_house(
...
extern int armas_x_housemult_w(armas_x_dense_t *A, armas_x_dense_t *tau, armas_x_dense_t *Q, int flags, armas_wbuf_t *wb, armas_conf_t *cf);

// Hyperbolic Householder functions
extern int armas_x_hhouse(
    armas_x_dense_t *a11, armas_x_dense_t *x, armas_x_dense_t *tau, int flags, armas_conf_t *cf);
...
extern int armas_x_update2_rbt(armas_x_dense_t *A, armas_x_dense_t *U, armas_x_dense_t *V, armas_conf_t *cf);

extern void armas_x_gen_rbt(armas_x_dense_t *U);

// Inverse
extern int armas_x_inverse_trm(armas_x_dense_t *A, int flags, armas_conf_t *cf);

extern int armas_x_luinverse(armas_x_dense_t *A, const armas_pivot_t *P, armas_conf_t *cf);

extern int armas_x_cholinverse(armas_x_dense_t *A, int flags, armas_conf_t *cf);

extern int armas_x_ldlinverse(armas_x_dense_t *A, const armas_pivot_t *P, int flags, armas_conf_t *cf);

extern int armas_x_luinverse_w(armas_x_dense_t *A, const armas_pivot_t *P, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_cholinverse_w(armas_x_dense_t *A, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);

extern int armas_x_ldlinverse_w(
    armas_x_dense_t *A, const armas_pivot_t *P, int flags, armas_wbuf_t *wrk, armas_conf_t *cf);
...
extern int armas_x_mult_diag(armas_x_dense_t *A, DTYPE alpha, const armas_x_dense_t *D, int flags, armas_conf_t *cf);

extern int armas_x_solve_diag(armas_x_dense_t *A, DTYPE alpha, const armas_x_dense_t *D, int flags, armas_conf_t *cf);

extern int armas_x_pivot(armas_x_dense_t *A, armas_pivot_t *P, unsigned int flags, armas_conf_t *cf);

extern int armas_x_pivot_rows(armas_x_dense_t *A, armas_pivot_t *P, int flags, armas_conf_t *cf);
