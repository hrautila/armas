...
#define armas_set_all       armas_d_set_all
...
//
#define armas_uniform       armas_d_uniform
#define armas_uniform_at    armas_d_uniform_at
#define armas_normal        armas_d_normal
#define armas_normal_at     armas_d_normal_at
