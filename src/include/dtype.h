...
#if 0
// internally available functions
#define __matblk_add      __d_matblk_add
#define __matblk_scale    __d_matblk_scale
#define __matblk_print    __d_matblk_print
#define __vecblk_print    __d_vecblk_print
...
#if 0// extended precision functions
