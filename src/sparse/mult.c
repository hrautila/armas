...
static
int mult_csr_nn(armas_x_sparse_t * C,
                DTYPE alpha,
                const armas_x_sparse_t * A,
                const armas_x_sparse_t * B, armas_x_accum_t * spa)
{
    armas_x_spvec_t r;
    int i, p;
...
static
int mult_csr_nt(armas_x_sparse_t * C,
                DTYPE alpha,
                const armas_x_sparse_t * A,
                const armas_x_sparse_t * B, armas_x_accum_t * spa)
{
...
static
int mult_csr_tn(armas_x_sparse_t * C,
                DTYPE alpha,
                const armas_x_sparse_t * A,
                const armas_x_sparse_t * B, armas_x_accum_t * spa)
{
...
static
int mult_csr_tt(armas_x_sparse_t * C,
                DTYPE alpha,
                const armas_x_sparse_t * A,
                const armas_x_sparse_t * B, armas_x_accum_t * spa)
{
...
static
int mult_csc_nn(armas_x_sparse_t * C,
                DTYPE alpha,
                const armas_x_sparse_t * A,
                const armas_x_sparse_t * B, armas_x_accum_t * spa)
{
...
static
int mult_csc_tn(armas_x_sparse_t * C,
                DTYPE alpha,
                const armas_x_sparse_t * A,
                const armas_x_sparse_t * B, armas_x_accum_t * spa)
{
...
static
int mult_csc_nt(armas_x_sparse_t * C,
                DTYPE alpha,
                const armas_x_sparse_t * A,
                const armas_x_sparse_t * B, armas_x_accum_t * spa)
{
...
// sparse CSR multiply:  C = alpha*A^T*B^T
static
int mult_csc_tt(armas_x_sparse_t * C,
                DTYPE alpha,
                const armas_x_sparse_t * A,
                const armas_x_sparse_t * B, armas_x_accum_t * spa)
{
...
size_t armassp_x_mult_nnz(const armas_x_sparse_t * A,
                          const armas_x_sparse_t * B, int flags)
{
                       ...
                       int flags, armas_wbuf_t * w, armas_conf_t * cf)
{
    ...
    armas_x_accum_t spa;
    armas_x_accum_make(&spa, armas_x_accum_dim(C), armas_wreserve_bytes(w, sz),
                       armas_wbytes(w));
